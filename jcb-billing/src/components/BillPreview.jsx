...
//           <h1 className="text-4xl font-bold text-blue-700 mb-2">{bizInfo.company_name || 'JCB Services'}</h1>
...
//               <span className={`px-2 py-1 rounded text-xs font-semibold ${bill?.payment_status === 'Paid' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'}`}>
...
//               </p>
//               <p>
//                 <span className="font-semibold">Hours:</span> {bill?.hours_worked} hrs
//               </p>
//               <p>
//                 <span className="font-semibold">Rate:</span> ₹{bill?.hourly_rate}/hr
//               </p>
//             </div>
//           </div>
//         </div>
...
//                   JCB Hourly Rate ({bill?.hours_worked} hrs × ₹{bill?.hourly_rate})
//                 </td>
//                 <td className="text-right p-3 text-gray-800 font-semibold">
//                   {(bill?.hours_worked * bill?.hourly_rate).toFixed(2)}
//                 </td>
//               </tr>
...
//                   <td className="text-right p-3 text-gray-800 font-semibold">
//                     {parseFloat(bill.operator_charge).toFixed(2)}
//                   </td>
//                 </tr>
//               )}
...
//                   <td className="text-right p-3 text-gray-800 font-semibold">
//                     {parseFloat(bill.fuel_charge).toFixed(2)}
//                   </td>
//                 </tr>
//               )}
...
//                   <td className="text-right p-3 text-gray-800 font-semibold">
//                     {parseFloat(bill.transport_charge).toFixed(2)}
//                   </td>
//                 </tr>
//               )}
//             </tbody>
